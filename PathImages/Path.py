...
def walk_VET_VEB_path():
    ...
    for file in os.listdir(directory):
        ...
        pyautogui.moveRel(0, 100, duration=.75)  # pointer can block the map and cause missed template match
        time.sleep(17)
...
def walk_willows_Bank():
    directory = 'A:/Jaeger/UnityProjects/RS_Bot/PathImages/DraynorWillows/'


def walk_Bank_Willows():
    pass
